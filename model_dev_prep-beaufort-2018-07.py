...
flist = casename + '.ww3.hi.'+year+'-'+monsel+'*.nc'
...
ww2012monsel = ww2012.sel(time=slice('2012-'+monsel+'-01','2012-'+monsel+'-31'))
print(len(dfiles), len(ww2012monsel.time[0:N]))
...
mfds_temp = xr.open_mfdataset(dfiles,
                              ...
                              parallel=False)
mfds_temp['time'] = ww2012monsel.time[0:N]
